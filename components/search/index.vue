	...
	<view class="page" v-show="show">
		...
		<view class="search-header">
			<view class="search-wrap">
				<view class="search-input">
					<input type="text" confirm-type="search" placeholder="请输入影视名字" :focus="isFocus" :value="keywords" @input="setKeywords" @confirm="goSearch($event)" />
				</view>
				<!--   搜索的按钮  -->
		...
		<view class="search-main">
			...
			<view class="search-area">
				<view class="search-name-wrap"><view class="search-name">热门搜索</view></view>
				<view class="search-kwords">
					<view class="kwords">神隐</view>
					<view class="kwords">你也有今天</view>
					<view class="kwords">仙剑4</view>
					<view class="kwords">仙剑6</view>
				</view>
			</view>
		</view>
	</view>
...
.search-header .search-wrap .search-input {
	width: 85%;
	height: 100%;
	border-right: 1px solid #b2b2b2;
}
.search-header .search-wrap .search-input input {
	width: 90%;
	height: 100%;
	font-size: 28rpx;
	padding-left: 20rpx;
}
.search-header .search-wrap .search-btn {
	width: 50rpx;
	height: 50rpx;
	background-image: url('https://movie-info-1320192491.cos.ap-guangzhou.myqcloud.com/search_components_page%2Fsearch_icon.png');
	background-size: 100%;
	background-repeat: no-repeat;
	background-position: center;
	margin-right: 20rpx;
...
.search-main .search-area .search-name-wrap {
	width: 100%;
	display: flex;
	justify-content: space-between;
	margin-top: 20rpx;
}
.search-main .search-area .bin {
	width: 40rpx;
	height: 40rpx;
	background-image: url('https://movie-info-1320192491.cos.ap-guangzhou.myqcloud.com/search_components_page%2Fbin.png');
	background-size: 100%;
	background-repeat: no-repeat;
	background-position: center;
}
.search-main .search-area .search-name {
	font-size: 28rpx;
}
.search-main .search-area .search-kwords {
	width: 100%;
	display: flex;
	flex-wrap: wrap;
	margin-top: 20rpx;
}
.search-main .search-area .search-kwords .kwords {
	width: 170rpx;
	height: 64rpx;
	background-color: #ffffff;
